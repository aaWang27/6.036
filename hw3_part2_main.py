...
if False:                               # set to True to see histograms
    ...
    for feat in range(auto_data.shape[0]):
        ...
        plt.hist(auto_data[feat,auto_labels[0,:] > 0], label=feat)
        plt.hist(auto_data[feat,auto_labels[0,:] < 0], label=feat)
        plt.show()
        # Plot histograms in two windows, different colors
        fig,(a1,a2) = plt.subplots(nrows=2)
        a1.hist(auto_data[feat,auto_labels[0,:] > 0], label=feat)
        a2.hist(auto_data[feat,auto_labels[0,:] < 0], label=feat)
        plt.legend(loc='best')
        plt.show()
...
acc1 = hw3.xval_learning_alg(hw3.perceptron, auto_data, auto_labels, 10, 50)
acc2 = hw3.xval_learning_alg(hw3.averaged_perceptron, auto_data, auto_labels, 10, 50)
print(acc1)
print(acc2)
#-------------------------------------------------------------------------------
# Review Data
#-------------------------------------------------------------------------------
hw3.xval_learning_alg(hw3.averaged_perceptron, auto_data, auto_labels, 10, 1)
